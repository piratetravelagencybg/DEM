...
export const metadata: Metadata = {
  ...
  description: 'Мебели по поръчка в Дупница. Кухни, гардероби, спални. Безплатна консултация. Обадете се: 0888 123 456',
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="font-body text-warm-gray leading-relaxed" style={{ fontSize: '1.05rem' }}>
              Обслужваме клиенти в Дупница и района. Изработваме мебели по поръчка с безплатен 3D проект и монтаж.
            </p>
